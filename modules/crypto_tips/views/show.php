...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('crypto_tips/manage', 'View All Crypto Tips', array("class" => "button alt"));
        echo anchor('crypto_tips/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="two-col">
    <div class="card record-details">
        ...
        <div class="card-body">
            <div><span>Article Headline</span><span><?= $article_headline ?></span></div>
            <div><span>Article Body</span><span><?= $article_body ?></span></div>
        </div>
    </div>
    <div class="card">
        <div class="card-heading">
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('crypto_tips/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Crypto Tip record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
